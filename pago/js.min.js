...
f(g);$("#cart-component .flight-info-sidebar").append($("#fare-rules-anchor"));$("#modify-search-trigger").addClass("modify");},a=function(){var e=$("#booking-process li").last();
if(!e.hasClass("one")&&!e.hasClass("two")){var d=$("#booking-process li");d.removeClass("one two");d.each(function(f){$(this).addClass(((f+1)%2===0)?"two":"one");
});}if($(".flight-info-sidebar").length<1){$("#cart-component .component-top").append($("#modify-search-trigger"));b();$("#title-search").append($("#modify-search-trigger"));
}c=setTimeout(function(){a();},300);},c=setTimeout(function(){a();},300);};