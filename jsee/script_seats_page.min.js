window.onload=function(){(function(){var a=false;$("#booking-process").addClass("active");$("#booking-process li").each(function(b){$(this).addClass(((b+1)%2===0)?"two":"one");
...
}if($(this).hasClass("prevPast")){$(this).removeClass("prevPast").addClass("prevFuture");}}if($(this).hasClass("stepCurrent")){a=true;}});})();(function(){var d=$(".seat-map-keys").first(),g=$(".seat-map-invocation").first(),b=$(".seat-map-footer-links").first(),f=$("#flight-list-infobox");
g.after(d);f.append(b);$(".seat-map-flights-list").each(function(){$(this).html("<span class='seat-map-text-info'>M&aacute;s informaci&oacute;n de este vuelo</span>");
...
n.month=l[parseInt(o[1])-1];n.day=parseInt(o[0]);return n;},k=[],j=function(n){var m=$("<div class='flight-info-sidebar'>"),l='<div class="head"><h2><i></i>Información de vuelo</h2></div>';
