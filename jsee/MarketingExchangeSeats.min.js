...
});})(window);$(document).ready(function(){var b=$(".seat-map-keys").first(),d=$(".seat-map-invocation").first(),a=$(".seat-map-footer-links").first(),c=$("#flight-list-infobox");
d.after(b);c.append(a);(function(){var e=false;$("#booking-process").addClass("active");$("#booking-process li").each(function(f){$(this).addClass(((f+1)%2===0)?"two":"one");
...
}if($(this).hasClass("prevPast")){$(this).removeClass("prevPast").addClass("prevFuture");}}if($(this).hasClass("stepCurrent")){e=true;}});})();$(".seat-map-flights-list").each(function(){$(this).html("<span class='seat-map-text-info'>M&aacute;s informaci&oacute;n de este vuelo</span>");
...
$(".seat-map-header-links").hide();$(".seat-map-planemap tr").each(function(e){$(this).find("td").each(function(f){var g=$(this).find("strong").first();
if(g.children().length>0){if(f===0){g.html("<img src='https://s3.amazonaws.com/aeromexico/ancillaries/new_v_exitleft.png'>");}else{g.html("<img src='https://s3.amazonaws.com/aeromexico/ancillaries/new_v_exitright.png'>");
}}});});});