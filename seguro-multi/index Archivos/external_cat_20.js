			...
			if( jQuery('#main-Page').hasClass('viewSeatMap') && isSSR != null ){
				...
				jQuery(".rightContent").each(function(){
					...
					jQuery.each(discountPass, function(a,b){
						var secure = '<div class="leftContent"><img src="https://s3.amazonaws.com/aeromexico/servicios_pass.png"></div><div class="rightContent"><h3>Descuentos en México</h3><p>Disfruta de grandes descuentos en conciertos, cines, restaurantes, hoteles y más con las mejores marcas del mercado. Además aprovecha el beneficio exclusivo de ganar 2 pases gratis para espectáculos y obras de teatro y acceso al cine VIP 2x1.</p></div>',
					...
					jQuery.each(secure, function(a,b){
						var secure = '<div class="leftContent"><span class="icon-es-contigo"></span></div><div class="rightContent"><h3>Beneficio en tierra, aire y durante tu estancia</h3><p><span class="subtitle">Aeroméxico está contigo en todo tu viaje, ya que te protege</span> horas antes de salida del vuelo, duante tu estancia y 12 horas después del regreso a casa.</p><p class="subtitle">Cuentas con diferentes beneficios y coberturas, algunas de éstas son:</p><ul><li>Gastos médicos</li><li>Muerte accidental</li><li>Pérdida de equipaje</li><li>Demora de equipaje</li><li>Servicios de Asistencia médica, legal y en viajes.</li></ul></div>',
							div = $("<div class='rightContent end-select'>");
				...
				jQuery(".aebags_psg_details").each(function(a){
					...
					if(es_us){
						...
						div.append('<div class="rightContent"><h3>Pago anticipado de exceso de equipaje</h3><p><span class="subtitle">Evita contratiempos en el aeropuerto, ahora puedes pagar de manera anticipada el Exceso de Equipaje.</span><br>Conoce la política de equipaje <a href="http://www.aeromexico.com/mx/tu-vuelo/antes-de-comprar/reglamentos-y-politicas/politicas-de-equipaje.html">aquí</a>.</p><p><span class="subtitle">Indica cu&aacute;s piezas extras pagar&aacute;s</span></p></div>');
