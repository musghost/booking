		...
		/* Paso 5 y elegir asientos viewSeatMap */
			...
			if ( jQuery('#main-Page').hasClass('viewSeatMap') ) {
				...
				(function(){
					...
					/* Cambio de &iacute;conos SeatMap */
					var iconsMap = {
			...
			} else if(jQuery("#main-Page").hasClass('viewAirExtras')){
				jQuery('#steps-image').css('background-position', '0 -255px');
				var secureActive = true,
					firstMatch = false;
				$("#tabview .ui-widget-header a").each(function(){
					var num = parseInt($.trim($(this).html()));
					if(num >= 5000 && num <= 8449){
						secureActive = false;
					}
    			});
				...
				$(".ui-tabs-nav a").each(function(){
					$(this).html("AM #" + $(this).html());
				});

				(function(){
				    var margin = "";
				    $("#tabview .m70Tab .ui-state-default").each(function(a){
				        if($(this).hasClass("m70Arrival")){
				            if(a >= 0){
				                switch(a){
				                    case 3:  margin = 0;
				                        break;
				...
				$(".rightContentBag").show();
				$("#paxDetails .m70buttonContainer").hide();
				$("input[aecode='99-AMC']").attr("checked", "checked");
				
				jQuery(".rightContent").each(function(aEach){
					var rightContent = jQuery(this),
						discountPass = [],
						secure = [],
						others = [],
						green = [],
						parent = jQuery(this).parent();
					jQuery(this).find(".m70contentRight input").each(function(){
						var aecode = jQuery(this).attr("aecode"),
							parent = jQuery(this).parent().clone();
						if(aecode === "99-DPM")
							discountPass.push(parent);
						else if(aecode === "99-AMC"){
							secure.push(parent);
							if(aEach === 0) firstMatch = true;
						}
						else if(aecode === "99-CO2")
							green.push(parent);
					...
					jQuery.each(discountPass, function(a,b){
						var secure = '<div class="leftContent"><img src="https://s3.amazonaws.com/aeromexico/servicios_pass.png"></div><div class="rightContent"><h3>Discount Pass</h3><p>Tu pase incluye 2 entradas gratis para espectáculos u obras de teatro y 2x1 en salas VIP. Además obtienes descuentos para conciertos, cines, restaurantes, hoteles y más. <a href="http://www.aeromexico.com/mx/productos/aeromexico-discount-pass.html" target="_blank">Leer m&aacute;s</a></p></div>',
							div = $("<div class='rightContent end-select'>");

						div.append(b);

						parent.append(secure);
						parent.append(div);
					});
					if(secureActive === true && firstMatch === true){
						jQuery.each(secure, function(a,b){
							var secure = '<div class="leftContent"><span class="icon-es-contigo"></span></div><div class="rightContent"><h3>Seguro de Viaje</h3><p>Con cobertura  horas antes de volar, durante tu viaje y hasta 12 horas después del regreso que incluye beneficios como:</p><ul><li>Gastos m&eacute;dicos</li><li>Muerte accidental</li><li>P&eacute;rdida de equipaje</li><li>Demora de equipaje</li><li>Servicios de Asistencia m&eacute;dica, legal y en viajes.</li></ul><p><a href="http://www.aeromexicoseguro.com" target="_blank">Leer m&aacute;s</a></p></div>',
								div = $("<div class='rightContent end-select'>");
					...
					jQuery.each(green, function(a,b){
						var secure = '<div class="leftContent"><span class="icon-green"></span></div><div class="rightContent"><h3>Vuela verde</h3><p>Participa, tu donaci&oacute;n contribuye a conservar la Selva Maya.</p><p><a href="http://www.aeromexico.com/mx/promociones/vuela-verde.html" target="_blank">Conoce m&aacute;s aqu&iacute;</a></p></div>',
							div = $("<div class='rightContent end-select'>");
					...
					jQuery.each(others, function(a,b){
						div = $("<div class='rightContent end-select'>");
						div.append(b);
						parent.append(div);
					});
				...
				jQuery(".aebags_psg_details").each(function(a){
					var ancillaries = [],
						sport = [],
						parent = $(this).parent(),
						div = $("<div>"),
						divPay = $("<div class='rightContent end-select'>"),
						divSport = $("<div class='rightContent end-select'>"),
						node = $(this);
					node.find(".m70contentRight input").each(function(b){
						var input = $(this),
							amCode = input.attr("aecode");
						if(amCode === "BG-0CD" ||
							amCode === "BG-0CE" ||
							amCode === "BG-0CF" ||
							amCode === "BG-0CG"){
							ancillaries.push(input.parent().clone());
						} else if(
							amCode === "BG-0GI" || 
							amCode === "BG-0GD" || 
							amCode === "BG-0EE" ||
							...
							amCode === "BG-0DD" ||
							amCode == "BG-0EC"){
							sport.push(input.parent().clone());
						}
					});
					div.append('<div class="leftContent"><span class="icon-pay"></span></div>');
					if(es_us === true || idiomaType === "es"){
						div.append('<div class="rightContent"><h3>Pago anticipado de exceso de equipaje</h3><p><span class="subtitle">Ahorra tiempo y dinero. Cómpralo ahora a un precio preferencial.</p><p><span class="subtitle">¿Cuántas piezas extras deseas llevar? <i>El precio es acumulable por cada maleta.</i></span></p></div>');
					} else{
						div.append('<div class="rightContent"><h3>Excess baggage prepayment</h3><p><span class="subtitle">Avoid mishaps at airport, now you can pay in advance the excess baggage.</span><br>Read the baggage policy <a href="http://www.aeromexico.com/us/travel-information/before-your-purchase/regulations-and-policies/baggage-policy.html">here</a>.</p>	<p><span class="subtitle">Point to how many extra pieces you want to pay:</span></p></div>');
					}
					$.each(ancillaries, function(key, val){
						divPay.append(val);
					});
					div.append(divPay);
					if(es_us === true || idiomaType === "es"){
						div.append('<div class="leftContent"><span class="icon-sport"></span></div><div class="rightContent"><h3>Equipo Deportivo</h3><p>Ahora te ofrecemos llevar contigo tu equipo deportivo.<br>Disponible para:</p></div>');
					} else {
						div.append('<div class="leftContent"><span class="icon-sport"></span></div><div class="rightContent"><h3>Sports Equipment</h3><p>We offer you the possibility to carry your sports equipment, available with:</p></div>');
					}
