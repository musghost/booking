...
var MaxLenPhoneNumber = 15;
	...
	//Función para generar el Session_ID y disparar los eventos de CyberSource
	function DeviceFingerPrint()
	{
		...
		//Creación e inserción de propiedades del objeto de flash
		...
		//Creación e inserción de propiedades del objeto Script
		...
		//Creación e inserción de propiedades del objeto Imagen
		...
		//Creación e inserción de propiedades del objeto Párrafo
		...
		eventoFingerPrint(
			function() 
			{
				...
				if(document.getElementById('cardHolderName').value != null )
					...
					NTH = "";				
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH;
				...
				if(typeof document.forms[0].billingAddress1 != "undefined" && document.forms[0].billingAddress1.value != null )
					...
					THDirPrincipal="";
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal;
				...
				if(typeof document.forms[0].billingAddress2 != "undefined" && document.forms[0].billingAddress2.value != null )
					...
					THDirComp="";
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal+'|THDirComp:='+THDirComp;
				...
				if(typeof document.forms[0].billingCity != "undefined" && document.forms[0].billingCity.value != null )
					...
					THCiudad="";
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal+'|THDirComp:='+THDirComp+'|THCiudad:='+THCiudad;
				...
				if(typeof document.forms[0].billingStateProv != "undefined" && document.forms[0].billingStateProv.value != null )
					...
					THEstado="";
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal+'|THDirComp:='+THDirComp+'|THCiudad:='+THCiudad+'|THEstado:='+THEstado;
				...
				if(typeof document.forms[0].billingCountry != "undefined" && document.forms[0].billingCountry.value != null )
					...
					THPais="";
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal+'|THDirComp:='+THDirComp+'|THCiudad:='+THCiudad+'|THEstado:='+THEstado+'|THPais:='+THPais;
				...
				if(typeof document.forms[0].billingZip != "undefined" && document.forms[0].billingZip.value != null )
					...
					THCP="";
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal+'|THDirComp:='+THDirComp+'|THCiudad:='+THCiudad+'|THEstado:='+THEstado+'|THPais:='+THPais+'|THCP:='+THCP;
				...
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal+'|THDirComp:='+THDirComp+'|THCiudad:='+THCiudad+'|THEstado:='+THEstado+'|THPais:='+THPais+'|THCP:='+THCP+'|THTel:='+THTel;
				...
				if(typeof document.forms[0].cardHolderEmail != "undefined" && document.forms[0].cardHolderEmail.value != null )
					...
					THEmail="";
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal+'|THDirComp:='+THDirComp+'|THCiudad:='+THCiudad+'|THEstado:='+THEstado+'|THPais:='+THPais+'|THCP:='+THCP+'|THTel:='+THTel+'|THEmail:='+THEmail;
				...
				window.name = 'FPSID:='+FPSID+'|NTH:='+NTH+'|THDirPrincipal:='+THDirPrincipal+'|THDirComp:='+THDirComp+'|THCiudad:='+THCiudad+'|THEstado:='+THEstado+'|THPais:='+THPais+'|THCP:='+THCP+'|THTel:='+THTel+'|THEmail:='+THEmail+'|TipoPago:='+TipoPago;
	...
	//Función que envía Session_ID y PNR al WebService de FingerPrint
	function WebServiceFingerPrint()
	{		
		// Data for DevLab Environment
		var wb_source = "http://172.18.113.80:8090/FingerPrintSessions.asmx/";
		var wb_method = "StoreFingerPrint";		
		var swf_source = "http://172.18.113.80:8090/FFPDev.swf";
		...
		var variables = {FPSID:FPSID,PNR:PNR,NTH:NTH,THDirPrincipal:THDirPrincipal,THDirComp:THDirComp,THCiudad:THCiudad,THEstado:THEstado,THPais:THPais,THCP:THCP,THTel:THTel,THEmail:THEmail,Currency:Currency,TotalPrice:TotalPrice,NAV:NAV+",1",TipoPago:TipoPago};
		...
		//Intento 2
		var parameters = "FPSID=" + FPSID + "&PNR=" + PNR + "&NTH=" + NTH + "&THDirPrincipal=" + THDirPrincipal + "&THDirComp=" + THDirComp + "&THCiudad=" + THCiudad +	"&THEstado=" + THEstado + "&THPais=" + THPais + "&THCP=" + THCP + "&THTel=" + THTel + "&THEmail=" + THEmail + "&Currency=" + Currency + "&TotalPrice=" + TotalPrice + "&NAV=" + NAV +",2"+ "&TipoPago="+ TipoPago;
	
		//Creación Objeto iFrame
		...
		parameters = "FPSID=" + FPSID + "&PNR=" + PNR + "&NTH=" + NTH + "&THDirPrincipal=" + THDirPrincipal + "&THDirComp=" + THDirComp + "&THCiudad=" + THCiudad +	"&THEstado=" + THEstado + "&THPais=" + THPais + "&THCP=" + THCP + "&THTel=" + THTel + "&THEmail=" + THEmail + "&Currency=" + Currency + "&TotalPrice=" + TotalPrice + "&NAV=" + NAV +",3"+ "&TipoPago="+ TipoPago;
	...
	function ReemplazapCarEsp(cadena)
	{
		...
		try
		{
			...
			new_cad = new_cad.replace("Á","A"); new_cad = new_cad.replace("À","A");
			new_cad = new_cad.replace("É","E"); new_cad = new_cad.replace("È","E");
			new_cad = new_cad.replace("Í","I"); new_cad = new_cad.replace("Ì","I");
			new_cad = new_cad.replace("Ó","O"); new_cad = new_cad.replace("Ò","O");
			new_cad = new_cad.replace("Ú","U"); new_cad = new_cad.replace("Ù","U");
			new_cad = new_cad.replace("á","A"); new_cad = new_cad.replace("à","A");
			new_cad = new_cad.replace("é","E"); new_cad = new_cad.replace("è","E");
			new_cad = new_cad.replace("í","I"); new_cad = new_cad.replace("ì","I");
			new_cad = new_cad.replace("ó","O"); new_cad = new_cad.replace("ò","O");
			...
			new_cad = new_cad.replace("Ä","A"); new_cad = new_cad.replace("Â","A");
			new_cad = new_cad.replace("Ë","E"); new_cad = new_cad.replace("Ê","E");
			new_cad = new_cad.replace("Ï","I"); new_cad = new_cad.replace("Î","I");
			new_cad = new_cad.replace("Ö","O"); new_cad = new_cad.replace("Ô","O");
			new_cad = new_cad.replace("Ü","U"); new_cad = new_cad.replace("Û","U");
			new_cad = new_cad.replace("ä","A"); new_cad = new_cad.replace("â","A");
			new_cad = new_cad.replace("ë","E"); new_cad = new_cad.replace("ê","E");
			new_cad = new_cad.replace("ï","I"); new_cad = new_cad.replace("î","I");
			new_cad = new_cad.replace("ö","O"); new_cad = new_cad.replace("ô","O");
			...
			new_cad = new_cad.replace("Ã","A"); new_cad = new_cad.replace("å","A");
			new_cad = new_cad.replace("Ñ","%D1"); new_cad = new_cad.replace("Å","A");
			new_cad = new_cad.replace("Õ","O"); new_cad = new_cad.replace("Ç","%C7");
			new_cad = new_cad.replace("ã","A"); new_cad = new_cad.replace("ç","%E7");
			new_cad = new_cad.replace("ñ","%F1"); new_cad = new_cad.replace("Ý","Y");
			new_cad = new_cad.replace("õ","O"); new_cad = new_cad.replace("ý","Y");
			new_cad = new_cad.replace("Ø","%D8"); new_cad = new_cad.replace("ÿ","Y");
			new_cad = new_cad.replace("ø","%F8"); new_cad = new_cad.replace("Þ","%DE");
			new_cad = new_cad.replace("Ð","%D0"); new_cad = new_cad.replace("þ","%FE");
			new_cad = new_cad.replace("ð","%F0"); new_cad = new_cad.replace("Æ","%C6");
			new_cad = new_cad.replace("ß","%DF"); new_cad = new_cad.replace("æ","%E6");
			...
			new_cad = new_cad.replace("ª","%AA"); new_cad = new_cad.replace("¤","%A4");
			...
			new_cad = new_cad.replace("µ","%B5"); new_cad = new_cad.replace("º","%BA");
