...
}}},i=[],h=function(n){var m=$("<div class='flight-info-sidebar'>"),k='<div class="head"><h2><i></i>Información de vuelo</h2></div>',j=$(".component-section.cart-pax").find("span"),l="",o=$("<h3 class='passenger'>");
...
p.append(y);p.append(z);});if(t===0||t<0){u.html("Sin escalas");}else{if(t==1){u.html("1 escala");}else{u.html(t+" escalas");}}s.html(q.flightNumber);p.append(s);
...
var p=q.andSelf().contents().filter(function(){return this.nodeType===3;})[1].textContent;if(typeof p==="undefined"){p="";}else{p=$.trim(q.find("span").first().html()+p);
