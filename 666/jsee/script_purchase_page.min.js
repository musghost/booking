...
}if($(this).hasClass("prevPast")){$(this).removeClass("prevPast").addClass("prevFuture");}}if($(this).hasClass("stepCurrent")){d=true;}});})();var b=function(){var d=function(i){var h=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],k=i.split("/"),j={};
j.month=h[parseInt(k[1])-1];j.day=parseInt(k[0]);return j;},g=[],f=function(l){var k=$("<div class='flight-info-sidebar'>"),i='<div class="head"><h2><i></i>Información de vuelo</h2></div>',h=$(".component-section.cart-pax").find("span"),j="",m=$("<h3 class='passenger'>");
...
n.append(v);n.append(w);});if(q===0||q<0){r.html("Sin escalas");}else{if(q==1){r.html("1 escala");}else{r.html(q+" escalas");}}n.append(r);k.append(n);
