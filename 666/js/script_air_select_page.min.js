...
});if(i===0){var k=$(this).find("th");k.eq(1).hide();k.eq(2).hide();k.eq(3).hide();k.eq(4).hide();k.eq(0).width("190px");}else{var m=$(this).find("td");
m.eq(4).hide();m.eq(1).hide();m.eq(2).hide();m.eq(3).hide();var h=m.eq(2).find("span").html(),g=m.eq(3).find("span").html(),n=$.trim(m.eq(4).html());var l=$("<ul class='airp'>"),j=$('<h3 class="scale">');
...
j.html("Nonstop");if($(this).attr("id")==="flight-advisory-inbound-row"){$(this).remove();return;}m.eq(0).prepend(l,j);$(this).find("a").addClass("info-plus").html("<i></i><span>Additional information</span>");
}});$("#cart-component .component-top").append($("#fare-rules-anchor"),$("#modify-search-trigger"));$(".flight-info-sidebar").remove();b();$(".flight-info-sidebar").first().append($("#fare-rules-anchor"));
...
m.eq(4).hide();m.eq(1).hide();m.eq(2).hide();m.eq(3).hide();var h=m.eq(2).find("span").html(),g=m.eq(3).find("span").html(),n=$.trim(m.eq(4).html());var l=$("<ul class='airp'>"),j=$('<h3 class="scale">');
l.html("<li><span>"+c[0]["nodea"]+"</span><span>"+h+'</span></li><li class="middle"><i></i></li><li><span>'+c[0]["nodeb"]+"</span><span>"+g+"</span></li>");
j.html("Nonstop");if($(this).attr("id")==="flight-advisory-both-row"){$(this).remove();return;}m.eq(0).prepend(l,j);$(this).find("a").addClass("info-plus").html("<i></i><span>Additional information</span>");
