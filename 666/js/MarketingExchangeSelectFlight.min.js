...
f.nodea=g.substr(1,3);f.nodeb=e.substr(1,3);c.push(f);});var b=function(){var e=function(j){var i=["January","February","March","April","May","June","July","August","September","October","November","December"],l=j.split("/"),k={};
k.month=i[parseInt(l[1])-1];k.day=parseInt(l[0]);return k;},h=[],g=function(m){var l=$("<div class='flight-info-sidebar'>"),j='<div class="head"><h2><i></i>Flight Information</h2></div>',i=$(".component-section.cart-pax").find("span"),k="",n=$("<h3 class='passenger'>");
...
l.append(n);l.append(f());$("#cart-component").prepend(l);},f=function(){var k=$("<div class='total-price'>"),i=$("<ul>"),j="";$(".cartPrices").last().find(".price-type").each(function(){var l=$("<li>"),m=$(this).find("span").eq(0).html(),n=$(this).find(".price-value");
