...
});})(window);var customScript=function(){$("#booking-process").addClass("active");$("#booking-process li").each(function(b){$(this).addClass(((b+1)%2===0)?"two":"one");
...
$(".seat-map-header-links").hide();$(".seat-map-planemap tr").each(function(b){$(this).find("td").each(function(a){var c=$(this).find("strong").first();
if(c.children().length>0){if(a===0){c.html("<img src='https://s3.amazonaws.com/aeromexico/ancillaries/new_v_exitleft.png'>");}else{c.html("<img src='https://s3.amazonaws.com/aeromexico/ancillaries/new_v_exitright.png'>");
}}});});};